 ...
 *
 */
public class CommitDiffs4TrainingMethods {

	private static Logger log = LoggerFactory.getLogger(CommitDiffs4TrainingMethods.class);
	
	public static void main(String[] args) {
		List<String> projectList = readList(Configuration4Training.JAVA_REPO_NAMES_FILE);
		for (String project : projectList) {
			traverseGitRepos(project, Configuration4Training.JAVA_REPOS_PATH + project + "/.git");
		}
	}
	...
	public static void traverseGitRepos(String projectName, String projectGit) {
		String revisedFilesPath = Configuration4Training.COMMIT_DIFF_PATH + projectName + "/revFiles/";
		String previousFilesPath = Configuration4Training.COMMIT_DIFF_PATH + projectName + "/prevFiles/";
		FileHelper.createDirectory(revisedFilesPath);
		FileHelper.createDirectory(previousFilesPath);
		FileHelper.deleteDirectory(Configuration4Training.COMMIT_DIFF_PATH + projectName + "/DiffEntries/");
